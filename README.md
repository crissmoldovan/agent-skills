...
audits and writes nothing, `draft` or `ensure` writes the layers, `update` takes only
what a change overtook. With no word at all it audits. In a harness with slash
commands that is
