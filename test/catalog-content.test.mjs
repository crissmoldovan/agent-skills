...
test('v0.16.0 release metadata, catalog, and review ownership cover the complete pack', async () => {
  assert.equal(rootPackage.version, '0.16.0');
  assert.equal(rootLock.version, '0.16.0');
  assert.equal(rootLock.packages[''].version, '0.16.0');
