...
test('v0.13.1 release metadata, catalog, and review ownership cover the complete pack', async () => {
  assert.equal(rootPackage.version, '0.13.1');
  assert.equal(rootLock.version, '0.13.1');
  assert.equal(rootLock.packages[''].version, '0.13.1');
